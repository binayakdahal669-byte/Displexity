; Displexity Language - 64-bit Windows Installer
...
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME} (64-bit)"
...
OutFile "displexity-x64-installer.exe"
...
VIAddVersionKey "FileDescription" "Displexity Programming Language (64-bit) Installer"
...
Section "!Compiler (Required)" SEC_COMPILER
  ...
  File "release\bin\win64\disp.exe"
  File "release\bin\win64\displexitycompiler.exe"
...
Section "-Post"
  ...
  FileWrite $0 "Displexity Programming Language (64-bit)$\r$\n"
  FileWrite $0 "====================================$\r$\n$\r$\n"
  ...
  WriteRegStr HKLM "${PRODUCT_UNINST_KEY}" "DisplayName" "${PRODUCT_NAME} (64-bit)"
